...
class Makes extends React.Component {
        ...
        return (
            <Modal show={this.state.viewDetail} onHide={this.closeModal.bind(this)}>
                <div className="mt-lg p-lg">
                    ...
                    <div className="h4 text-center">Make Information</div>
                    <Row className="pv-lg">
                        <Col lg={2}></Col>
                        <Col lg={8}>
                            ...
                            <div className="text-right"><a href="#" className="text-muted">Delete this make?</a>
                            </div>
                        </Col>
                    </Row>
                </div>
    ...
    render() {
        return (
            <ContentWrapper>
                <h3>Makes
                <small>You can add, edit and delete makes</small>
                </h3>
                { /* START panel */}
                <div className="panel panel-default">
                    <div className="panel-heading">Make List</div>
