    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            collapse: {
                ...
                order: this.routeActive('order'),
                service: this.routeActive(['devices', 'makes', 'models', 'services']),
                user: this.routeActive(['vendors', 'customers']),
                coin: this.routeActive('coin'),
                payment: this.routeActive('payment'),
                ...
                <div className="aside-inner">
                    <nav data-sidebar-anyclick-close="" className="sidebar">
                        ...
                        <ul className="nav">
                            ...
                            <li className={this.routeActive('order') ? 'active' : ''}>
                                <Link to="order" title="order">
                                    <div className="pull-right label label-success">30</div>
                                    <em className="icon-book-open"></em>
                                    <span data-localize="sidebar.nav.ORDER">Order</span>
                                </Link>
                            </li>
                           
                            <li className={this.routeActive(['customers', 'vendors']) ? 'active' : ''}>
                                <div className="nav-item" title="user" onClick={this.toggleItemCollapse.bind(this, 'user')}>
                                    <em className="icon-people"></em>
                                    <span data-localize="sidebar.nav.USERMANAGEMENT">User Management</span>
                                </div>
                                <Collapse in={this.state.collapse.user}>
                                    <ul id="user" className="nav sidebar-subnav">
                                        <li className="sidebar-subnav-header">User Management</li>
                                        <li className={this.routeActive('vendors') ? 'active' : ''}>
                                            <Link to="vendors" title="vendors">
                            ...
                            <li className={this.routeActive(['devices', 'makes', 'models', 'services']) ? 'active' : ''}>
                                <div className="nav-item" onClick={this.toggleItemCollapse.bind(this, 'service')}>
                                    <em className="icon-basket-loaded"></em>
                                    <span data-localize="sidebar.nav.SERVICE">Service Management</span>
                                </div>
                                <Collapse in={this.state.collapse.service} timeout={100}>
                                    <ul id="service" className="nav sidebar-subnav">
                                        <li className="sidebar-subnav-header">Service Management</li>
                                        <li className={this.routeActive('devices') ? 'active' : ''}>
                                            <Link to="devices" title="devices">
                                                <span>Devices</span>
                                            </Link>
                                        </li>
                                        <li className={this.routeActive('makes') ? 'active' : ''}>
                                            <Link to="makes" title="makes">
                                                <span>Makes</span>
                                            </Link>
                                        </li>
                                        <li className={this.routeActive('models') ? 'active' : ''}>
                                            <Link to="models" title="models">
                                                <span>Models</span>
                                            </Link>
                                        </li>
                                        <li className={this.routeActive('services') ? 'active' : ''}>
                            ...
                            <li className={this.routeActive('coin') ? 'active' : ''}>
                                <Link to="coin" title="coin">
                                    <em className="fa fa-bitcoin"></em>
                                    <span data-localize="sidebar.nav.COIN">Coin Management</span>
                                </Link>
                            </li>

                            <li className={this.routeActive('payment') ? 'active' : ''}>
                                <Link to="payment" title="payment">
                                    <em className="fa fa-money"></em>
                                    <span data-localize="sidebar.nav.MONEY">Payment</span>
                                </Link>
                            </li>
                            ...
                            <li className={this.routeActive('settings') ? 'active' : ''}>
                                <Link to="settings" title="settings">
                                    ...
                                    <span data-localize="sidebar.nav.SETTING">Setting</span>
                                </Link>
                            </li>
