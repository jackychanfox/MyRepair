                    ...
                    <div className="navbar-header">
                        <a href="#/" className="navbar-brand">
                            <div className="brand-logo">
                                <img src="img/logo-single.png" alt="App Logo" className="img-responsive" style={{height:35}}/>
                            </div>
                            <div className="brand-logo-collapsed">
                                <img src="img/logo-single.png" alt="App Logo" className="img-responsive" style={{height:40, objectFit:'auto'}}/>
                            </div>
                        </a>
                    </div>
                    { /* END navbar header */ }
