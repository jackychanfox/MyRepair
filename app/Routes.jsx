...
import VendorEdit from './components/User/VendorEdit';
                ...
                <CSSTransition key={currentKey} timeout={timeout} classNames={animationName}>
                    <div>
                        <Switch location={location}>
                            ...
                            {/*Dashboard*/}
                            <Route path="/dashboard" render={()=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<DashboardV1 />))}/>
                            ...
                            {/* User */}
                            <Route path="/vendors" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Vendor {...props}/>))}/>
                            <Route path="/vendor-edit" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<VendorEdit {...props}/>))}/>
                            ...
                            <Route path="/customers" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Customer {...props}/>))}/>
                            <Route path="/customer-edit" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<CustomerEdit {...props}/>))}/>

                            {/* Services */}
                            <Route path="/devices" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Devices {...props}/>))}/>
                            <Route path="/makes" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Makes {...props}/>))}/>
                            <Route path="/models" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Models {...props}/>))}/>
                            <Route path="/services" render={(props)=>(!AuthService.isLogin() ? (<Redirect to = "/login"/>):(<Services {...props}/>))}/>
